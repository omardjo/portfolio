...
import emailjs from '@emailjs/browser'; // Ensure you installed: npm install @emailjs/browser
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-3 bg-gray-900/50 border border-gray-700 rounded-xl text-white focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary transition-all"
              ...
              <div>
                ...
                <input 
                  type="number" id="captcha" required
