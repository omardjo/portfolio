...
export const Hero: React.FC = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden pt-24 md:pt-20">
      ...
      <div className="absolute top-1/4 -left-32 w-[380px] h-[380px] bg-[#36E3FF]/[0.06] rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-1/4 -right-32 w-[380px] h-[380px] bg-[#7C5CFF]/[0.06] rounded-full blur-[120px] pointer-events-none" />
